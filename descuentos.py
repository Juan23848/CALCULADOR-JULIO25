...
def get_descuentos(remunerativo: float, bonos: float, gremios: list) -> dict:
    legales = descuentos_legales(remunerativo)
    gremial = descuento_gremial(remunerativo, bonos, gremios)
    legales["gremial"] = gremial
    legales["total"] += gremial
    return legales
